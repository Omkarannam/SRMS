        ...
        <div class="sidebar-nav">
            <ul class="side-nav color-gray">
                ...
                <li class="has-children">
                    <a href="#"><i class="fa fa-file-text"></i> <span>Admin</span> <i class="fa fa-angle-right arrow"></i></a>
                    <ul class="child-nav">
                        <li><a href="add-admin.php"><i class="fa fa-bars"></i> <span>New Admin</span></a></li>
                        <li><a href="manage-admin.php"><i class="fa fa fa-server"></i> <span>Manage Admin</span></a></li>      
                    </ul>
                </li>
                <li class="has-children">
